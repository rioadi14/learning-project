                        ...
                        <nav class="menu__nav">
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="{{ ($route == 'home.portfolio') ? 'active' : '' }} menu-item-has-children "><a href="#">Portfolio</a>
                                        <ul class="sub-menu">
                                            <li><a href="{{ route('home.portfolio') }}">Portfolio</a></li>
                                            <li><a href="portfolio-details.html">Portfolio Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="{{ ($route == 'home.blog') ? 'active' : '' }} menu-item-has-children"><a href="{{ route('home.blog') }}">Our Blog</a>
                                        <ul class="sub-menu">
