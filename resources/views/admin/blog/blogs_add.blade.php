            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Here are form of <code class="highlighter-rouge">Add Blog</code> to your Blog Page.</p>
                        ...
                        @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="blog_tags"  value="home,tech" data-role="tagsinput" id="example-email-input">
                                </div> 
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                            ...
                            <!-- end row -->
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Preview Blog</label>
                                <div class="col-sm-10">
